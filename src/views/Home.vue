          ...
          <el-col class="hidden-sm-and-up" :span="4" :push="11">
            <el-dropdown>
              <el-button style="background-color: white; margin-top: 10px">
                <i
                  class="el-icon-arrow-down el-icon--right el-icon-menu"
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item
                  divided
                  @click.native="router_onClick('/home/hall')"
                  >Homepage</el-dropdown-item
                >
                <el-dropdown-item @click.native="router_onClick('/home/my')"
                  >Personal information</el-dropdown-item
                >
                <el-dropdown-item @click.native="router_onClick('/home/select')"
                  >Course selection</el-dropdown-item
                >
                <el-dropdown-item
                  @click.native="router_onClick('/home/schdule')"
                  >School timetable</el-dropdown-item
                >
                <el-dropdown-item @click.native="router_onClick('/home/serive')"
                  >Upgrade serive</el-dropdown-item
                >
              </el-dropdown-menu>
            </el-dropdown>
          </el-col>
            ...
            <el-col :span="24">
              ...
              >
                <el-menu-item index="1" @click="router_onClick('/home/hall')">
                  ...
                  <span slot="title" class="el-menu-item.is-active"
                    >Home page</span
                  >
                </el-menu-item>
...
export default {
  ...
  data() {
    return {
      ...
      options: [
        { value: "Home page" },
        { value: "Personal imformation" },
        { value: "Course selection" },
        { value: "School timetable" },
        { value: "Upgrade serive" },
      ],
      activeMenu: "",
    };
  },
