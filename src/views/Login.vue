      ...
      <el-row>
          ...
          <div>
            <el-row>
              <el-col :span="24" :md="24">
                <div class="title">
                  <h1 class="text1">
                    Academic Affairs System <br />of Hainan University
                  </h1>
                </div>
              </el-col>
            </el-row>
            ...
            <div v-if="$route.path === '/login/signin'">
              ...
              <el-row>
                <el-col :span="24" :md="24">
                  <el-button
                    @click="register_onClick('/login/register')"
                    class="el_button_register"
                    style="
            ...
            <div v-else>
              ...
              <el-row>
                <el-col :span="24" :md="24">
                  <el-button
                    @click="register_onClick('/login/signin')"
                    class="el_button_register"
                    style="
                      color: rgba(255, 255, 255, 1);
                      background-color: rgba(53, 87, 220, 1);
        ...
        <el-col :span="12" :md="12" :xs="{ span: 24 }">
          <div class="">
            ...
            <div v-if="$route.path === '/login/signin'">
              <h1 class="hidden-sm-and-up" style="margin-top: 30px">
                Don't have an account?
              </h1>
              <el-button
                @click="register_onClick('/login/register')"
                class="hidden-sm-and-up el_button_register"
                style="
                  color: rgba(255, 255, 255, 1);
