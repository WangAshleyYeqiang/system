  ...
  <div>
    <el-row type="flex" justify="center" style="text-align: center">
      <div v-on:keydown.enter="submitForm('form')">
        <el-col :push="3">
          <h1 class="text_1" style="margin-top: 20px; display: inline-block">
            Sign up for an Account
          </h1>
        </el-col>
        <el-col :push="3">
          <h2 class="text_2" style="display: inline-block">
        ...
        <el-form :model="form" :rules="rules" ref="form">
          ...
          >
            <el-select
              style="width: 55%; margin-left: 80px; display: inline-block"
              v-model.lazy="form.userGender"
              placeholder="Please your Gender"
          ...
          >
            <el-input
              style="width: 55%; margin-left: 83px"
          ...
          >
            <el-select
              ...
              v-model.lazy="form.userSchool"
              filterable
              placeholder="Select your School"
              @blur="validateField('userSchool')"
            >
              <el-option
          ...
          >
            <el-select
              style="width: 55%; margin-left: 95px"
              v-model.lazy="form.userType"
          ...
          >
            <el-input
              style="width: 55%; margin-left: 55px"
              v-model="form.userPassword"
              placeholder="Please set your Password"
              @blur="validateField('userRePassword')"
              show-password
            ></el-input>
          </el-form-item>
          ...
          >
            <el-input
              style="width: 55%"
              v-model="form.userRePassword"
              placeholder="Please repeat enter your Password"
    ...
    submitForm() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          axios
            .post("http://localhost:8081/userInfo/add", userInfo)
            .then((res) => {
              console.log(res);
              if (res.data) {
                this.$message({
